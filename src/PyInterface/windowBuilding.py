...
def playerTurnEffect(window, playerTurn):
    ...
    newfont1 = QtGui.QFont("SF Wasabi", 5)
    ...
    newfont2 = QtGui.QFont("SF Wasabi", 10)
    ...
    newfont3 = QtGui.QFont("SF Wasabi", 15)
    ...
    newfont4 = QtGui.QFont("SF Wasabi", 20)
    ...
    newfont5 = QtGui.QFont("SF Wasabi", 35)
    ...
    newfont5 = QtGui.QFont("SF Wasabi", 40)
