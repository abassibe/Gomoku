...
fn rust_ext(_py: Python<'_>, m: &PyModule) -> PyResult<()> {
    ...
    /// removed hint: &PyBool from argsm wasn't used
    fn get_next_move(goban: &PyArray2<u8>, p_color: u8, hint: u8, human_capture: i32, ai_capture: i32, last_move_human : Option<(u16, u16)>, last_move_ai : Option<(u16, u16)>) -> PyResult<(u32, u32)> {
