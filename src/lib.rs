...
fn launch_ai(input: Goban, computer_captures: u8, human_captures: u8) -> (u32, u32) {
    let mut algorithm = Algorithm::new();
    algorithm.update_initial_state(input, BitBoard::empty(), computer_captures, human_captures);
